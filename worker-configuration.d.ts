/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 9aa51ebc3ab50727f40d0f95a975d75d)
// Runtime types generated with workerd@1.20260430.1 2026-05-03 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/server");
		durableNamespaces: "StoreSafetyAgent" | "IsSafeMcp";
	}
	interface Env {
		DB: D1Database;
		CHECK_RATE_LIMIT: RateLimit;
		POLL_RATE_LIMIT: RateLimit;
		MCP_RATE_LIMIT: RateLimit;
		AI: Ai;
		AI_MODEL: "@cf/zai-org/glm-4.7-flash";
		CACHE_TTL_SECONDS: "604800";
		CLOUDFLARE_URL_SCANNER_VISIBILITY: "Unlisted";
		MAX_AI_CALLS_PER_DAY: "600";
		MAX_CHECKS_PER_DAY: "300";
		...
		IsSafeMcp: DurableObjectNamespace<import("./src/server").IsSafeMcp>;
	}
}
